...
- **做多信号**(引擎 15m 收线):候选 + `long_setup`(破 8 根实体高、收盘位≥0.6、上影≤6%、站上 EMA21≤12%、EMA8>EMA21)+ **long 模型打分≥阈值**(base85+资金流,标签"48h成妖币",走查 AUC~0.71、top5% 精度 72%、做多收益 18.3%>回撤 12%)。资金流特征实盘暂缺省(NaN,LGB 处理),退化到 base 水平,后续接实时 OI/多空/taker 补盈亏比。
